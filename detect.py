    ...
    for count, image_path in enumerate(images, 1):
        ...
        if FLAGS.crop:
            ...
            try:
                ...
                pass
            crop_objects(cv2.cvtColor(original_image, cv2.COLOR_BGR2RGB), pred_bbox, crop_path, allowed_classes, frame_num, motorcycle_classes, with_helmet_classes, no_helmet_classes, overloading_classes, platenumber_classes)
